...
const TABLE_NAME = 'it_pg_adapter';
const dbConfig = getTestPostgresConfig();

describe('Integration: PgWorkflowAdapter (real Postgres)', () => {
  let setupClient: Client;
  let pool: Pool;
  let adapter: PgWorkflowAdapter;
  ...
  beforeAll(async () => {
    ...
    adapter = new PgWorkflowAdapter(pool, TABLE_NAME);
  });
